...
- **Dashboard trackers** — party level, in-game day, an optional escalation tracker (freely named, with editable stage descriptions — “Vessimirs Eskalation” in the demo) and freely addable custom counters (“Selainestes Bisse 1/3”), all editable in place.
